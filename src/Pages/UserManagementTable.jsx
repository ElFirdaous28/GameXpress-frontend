...
export default function UserManagementTable() {
    ...
    const handleSaveEdit = async () => {
        try {
            const response = await api.put(`v1/admin/users/${editingUser.id}`, editingUser);
    ...
    const handleAddUser = async () => {
        try {
            const response = await api.post('v1/admin/users', newUser);
            ...
            {/* <Box component="main" sx={{ flexGrow: 1, bgcolor: 'background.default', p: 3 }}> */}
                ...
                <div className="p-6 bg-gray-800 rounded-lg shadow">
                    ...
                    <div className="overflow-x-auto">
                        <table className="min-w-full p-6 bg-gray-800 border border-gray-200 rounded-lg overflow-hidden">
                            <thead className="p-6 bg-gray-700 ">
                                <tr>
                                    ...
                                    <th className="py-3 px-4 text-left text-white font-medium">Rôle</th>
                            ...
                            <tbody className="divide-y divide-gray-200">
                                {filteredUsers.length > 0 ? (
                                    filteredUsers.map(user => (
                                        <tr key={user.id} className="hover:p-6 ">
